    ...
    <section {...props} className={outerClasses}>
      <div className="container">
        <div className={innerClasses}>
          ...
          <FormElements handleSubmitData={handleSubmitDataToEmail} />
          <Modal
            id="form-modal"
          ...
          >
            ...
            {emailStatus.success && <FormSuccess handleClose={closeModal} />}
            {emailStatus.failure && <FormError handleClose={closeModal} />}
          </Modal>
        </div>
      </div>
    </section>
