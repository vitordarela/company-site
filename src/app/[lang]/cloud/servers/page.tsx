...
import {
  getCloudServerData,
  getCloudServerHeader,
} from '../../../../utils/ServiceData'
import Cta from '../../components/sections/Cta'
import { getDictionary } from '../../../../get-dictionary';

async function CloudServers({ params: { lang } }) {

  const dict = await getDictionary(lang);
  const sectionHeader = getCloudServerHeader(dict.cloud_header);

  return (
    <>
      <GenericSection
        sectionHeader={sectionHeader}
        data={getCloudServerData(dict.cloud_data)}
        invertMobile
        topDivider
        imageFill
...
export async function generateMetadata({ params: { lang } }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        'CodeBe - ' + sectionHeader.title + ' - ' + sectionHeader.paragraph,
      url: 'https://www.codebe.dev/cloud/servers',
      siteName: 'CodeBe.dev',
      images: [
        {
    ...
    twitter: {
      ...
      site: 'https://www.codebe.dev/cloud/servers',
    }
  }
}
