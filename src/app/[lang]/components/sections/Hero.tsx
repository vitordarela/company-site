        ...
        <div className={innerClasses}>
          <div className="hero-content">
            <h1 className="mt-0 mb-16 reveal-from-left" data-reveal-delay="150">
              {getHomeHeroHeader(dictionary).title}{' '}
              <span className="text-color-primary">
                {getHomeHeroHeader(dictionary).subTitle}
              </span>
            </h1>
            <div className="container-xs">
              ...
              >
                {getHomeHeroHeader(dictionary).paragraph}
              </p>
          ...
          >
            ...
            >
              <Image
                ...
                src={getHomeHeroHeader(dictionary).imageURL}
                alt="Hero"
                width={896}
                height={504}
              />
          ...
          <Modal
            ...
            video={getHomeHeroHeader(dictionary).videoIFrame}
            videoTag="iframe"
          />
        </div>
      </div>
