        ...
        <div className={innerClasses}>
          ...
          >
            ...
            {emailStatus.success && !errors?.newsletterEmail && (
              <div className="label-error">
                <Image
                  ...
                  alt={dictionary.request_sent}
                  width={16}
                  height={16}
                />
                <span>{ dictionary.subscribed_success }</span>
              </div>
            )}
            ...
            {emailStatus.failure && !errors?.newsletterEmail && (
              <div className="label-error">
                <Image
                  ...
                  height={16}
                />
                <span>{ dictionary.subscribed_error }</span>
              </div>
            )}
            ...
            <Input
              ...
              id="newsletter"
              type="email"
              label={dictionary.subscribe_label}
              labelHidden
              hasIcon="right"
              placeholder={dictionary.subscribe_placeholder}
              required={true}
