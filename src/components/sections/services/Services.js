...
const ServicesContent = ({
  ...
  const serviceList = [
    ...
    },
    {
      ...
      imageURL: require('../../../assets/images/ecommerce.png'),
      link: 'ecommerce',
      description: [
        {
          title: '',
          ...
          imageURL: require('../../../assets/images/services/e-commerce-tab1.png'),
        },
        {
          subTitle: 'SOLUTIONS',
          ...
          imageURL: require('../../../assets/images/services/ecommerce-solutions.png'),
        },
        {
          subTitle: 'technology',
          ...
          imageURL: require('../../../assets/images/services/ecommerce-dev.png'),
        },
        {
          subTitle: 'technology',
          title: 'Shopify',
          ...
          imageURL: require('../../../assets/images/services/ecommerce-shopify.png'),
        },
        {
          ...
          imageURL: require('../../../assets/images/services/ecommerce-custom.png'),
        },
        {
          subTitle: 'Support',
          ...
          imageURL: require('../../../assets/images/services/ecommerce-support.png'),
        },
      ],
    },
    {
      ...
      imageURL: require('../../../assets/images/mobileapp2.png'),
      link: '',
      description: [
        {
    ...
    },
    {
      ...
      paragraph: 'Ajudamos você a conectar seus negócios.',
      imageURL: require('../../../assets/images/software-development.png'),
      link: '',
      description: [
        {
          title: 'Instalação e Configuração',
  ...
  const serviceData = serviceList.find((serviceItem) => serviceItem.link === service)
