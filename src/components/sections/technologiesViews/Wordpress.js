          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  ...
                  plataforma de código aberto Wordpress.
                </p>
              </div>
              <div
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  A Wordpress fornece uma série de ferramentas e soluções para
                  ajudar as empresas a gerenciar e implementar APIs, integrar
            ...
            <div className="split-item">
              ...
              >
                ...
                <div className="m-0">
                  <p>
                    Wordpress API Manager: Plataforma de gerenciamento de API.{' '}
                  </p>
                  <p>
                    Wordpress Enterprise Integrator: Plataforma de integração de
                    aplicativos
                  </p>
                  <p>
                    Wordpress Identity Server: Plataforma de gerenciamento de
                    identidade.
                  </p>
                </div>
              </div>
...
Wordpress.propTypes = propTypes
Wordpress.defaultProps = defaultProps
