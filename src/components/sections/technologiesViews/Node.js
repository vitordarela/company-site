          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  ...
                  plataforma de código aberto Nodejs.
                </p>
              </div>
              <div
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  A Nodejs fornece uma série de ferramentas e soluções para ajudar
            ...
            <div className="split-item">
              ...
              >
                ...
                <div className="m-0">
                  <p>Nodejs API Manager: Plataforma de gerenciamento de API. </p>
                  <p>
                    Nodejs Enterprise Integrator: Plataforma de integração de
                    aplicativos
                  </p>
                  <p>
                    Nodejs Identity Server: Plataforma de gerenciamento de
                    identidade.
                  </p>
                </div>
              </div>
...
Nodejs.propTypes = propTypes
Nodejs.defaultProps = defaultProps
