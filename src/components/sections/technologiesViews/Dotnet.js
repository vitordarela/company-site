          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  ...
                  plataforma de código aberto Dotnet.
                </p>
              </div>
              <div
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  A Dotnet fornece uma série de ferramentas e soluções para
            ...
            <div className="split-item">
              ...
              >
                ...
                <div className="m-0">
                  <p>
                    Dotnet API Manager: Plataforma de gerenciamento de API.{' '}
                  </p>
                  <p>
                    Dotnet Enterprise Integrator: Plataforma de integração de
                    aplicativos
                  </p>
                  <p>
                    Dotnet Identity Server: Plataforma de gerenciamento de
                    identidade.
                  </p>
                </div>
              </div>
...
Dotnet.propTypes = propTypes
Dotnet.defaultProps = defaultProps
