          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  ...
                  plataforma de código aberto Spring.
                </p>
              </div>
              <div
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  A Spring fornece uma série de ferramentas e soluções para ajudar
            ...
            <div className="split-item">
              ...
              >
                ...
                <div className="m-0">
                  <p>Spring API Manager: Plataforma de gerenciamento de API. </p>
                  <p>
                    Spring Enterprise Integrator: Plataforma de integração de
                    aplicativos
                  </p>
                  <p>
                    Spring Identity Server: Plataforma de gerenciamento de
                    identidade.
                  </p>
                </div>
              </div>
