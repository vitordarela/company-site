          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  ...
                  plataforma de código aberto Reactjs.
                </p>
              </div>
              <div
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  A Reactjs fornece uma série de ferramentas e soluções para ajudar
            ...
            <div className="split-item">
              ...
              >
                ...
                <div className="m-0">
                  <p>Reactjs API Manager: Plataforma de gerenciamento de API. </p>
                  <p>
                    Reactjs Enterprise Integrator: Plataforma de integração de
                    aplicativos
                  </p>
                  <p>
                    Reactjs Identity Server: Plataforma de gerenciamento de
                    identidade.
                  </p>
                </div>
              </div>
...
Reactjs.propTypes = propTypes
Reactjs.defaultProps = defaultProps
