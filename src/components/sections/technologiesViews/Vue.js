          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  ...
                  plataforma de código aberto Vue.
                </p>
              </div>
              <div
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  A Vue fornece uma série de ferramentas e soluções para ajudar
            ...
            <div className="split-item">
              ...
              >
                ...
                <div className="m-0">
                  <p>Vue API Manager: Plataforma de gerenciamento de API. </p>
                  <p>
                    Vue Enterprise Integrator: Plataforma de integração de
                    aplicativos
                  </p>
                  <p>
                    Vue Identity Server: Plataforma de gerenciamento de
                    identidade.
                  </p>
                </div>
              </div>
...
Vue.propTypes = propTypes
Vue.defaultProps = defaultProps
