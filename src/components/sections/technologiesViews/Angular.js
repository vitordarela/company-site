          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  ...
                  plataforma de código aberto Angular.
                </p>
              </div>
              <div
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                  A Angular fornece uma série de ferramentas e soluções para
            ...
            <div className="split-item">
              ...
              >
                ...
                <div className="m-0">
                  <p>
                    Angular API Manager: Plataforma de gerenciamento de API.{' '}
                  </p>
                  <p>
                    Angular Enterprise Integrator: Plataforma de integração de
                    aplicativos
                  </p>
                  <p>
                    Angular Identity Server: Plataforma de gerenciamento de
                    identidade.
                  </p>
                </div>
              </div>
...
Angular.propTypes = propTypes
Angular.defaultProps = defaultProps
